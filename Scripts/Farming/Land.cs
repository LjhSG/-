...
public class Land : MonoBehaviour, ITimeTracker
{
    ...
    void Start()
    {
        ...
        //SetObstacleStatus(FarmObstacleStatus.Wood);
    ...
    {
        ItemData tool = InventoryManager.Instance.GetEquippedSlotItem(InventorySlot.InventoryType.Tool);
        ...
        EquipmentData equipment = tool as EquipmentData;

        if(equipment != null)
        {
            EquipmentData.ToolType toolType = equipment.Type;
            switch(toolType)
            {
        ...
        SeedData seedTool = tool as SeedData;
    ...
    public CropBehaviour SpawnCrop()
    {
        ...
        //cropPrefab.transform.localScale = new Vector3(1.2f, 0.6f, 1.2f);
